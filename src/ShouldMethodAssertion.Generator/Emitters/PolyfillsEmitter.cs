...
internal static class PolyfillsEmitter
{
    ...
    public static void Emit(SourceProductionContext context, string args)
    {
        ...
        {
            var source = OverloadResolutionPriorityAttributeSource;

#if !DEBUG
            source = $"""
                {SourceGeneratorCommons.SourceBuilder.AutoGeneratedComment}
                {source}
                """;
#endif

            context.AddSource("Polyfills/OverloadResolutionPriorityAttribute.cs", source);
        }
    }
}
